            ...
            <div class="col-sm-12">
                <div class="iq-card">
                    ...
                    <div class="iq-card-body">
                        <form method="POST" action="{{ route('episode.add', ["id"=> $id ]) }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-12 form_gallery form-group">
                                    <label id="gallery3" for="form_gallery-upload1">File</label>
                                    <input data-name="#gallery3" id="form_gallery-upload1" name="filename"
